...
namespace SkillTrackerFront.Services
{
    public class DataAcces
    {
        ...
        public string Decrypturls(string encryptedText)
        {
            ...
            string enkey =/* keysection["EncryptKey"]*/"42358357407474453245745740747545";
        ...
        //public SessionD DecryptToken(string token)
        //{
        //    try
        //    {
        //        JwtSecurityTokenHandler tokenHandler = new JwtSecurityTokenHandler();
        //        JwtSecurityToken jwt = tokenHandler.ReadJwtToken(token);
        //        string EncrptedClaim = jwt.Claims.FirstOrDefault(c => c.Type == "encryptedClaims")?.Value;
        //        var decryptedclaim = Decrypturls(EncrptedClaim);
        //        var decrptjson = JsonConvert.DeserializeObject<Dictionary<string, string>>(decryptedclaim);
        //        SessionD Sesiondata = new SessionD
        //        {

        //            DealerCode = decrptjson["CardCode"],
        //            DealerName = decrptjson["CardName"],
        //            SlpCode = decrptjson["SlpCode"],
        //            Branch = decrptjson["Branch"],
        //            SapDB = decrptjson["SapDB"],
        //            SAPPassword = decrptjson["SAPPassword"],
        //            SAPUrl = decrptjson["SAPUrl"],
        //            SAPUserName = decrptjson["SAPUserName"],
        //            Taxcode = decrptjson["Taxcode"]
